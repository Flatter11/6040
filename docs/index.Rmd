...
8. LASSO regression [Lecture note|Practical](https://flatter11.github.io/6040/8.-LASSO-regression)
   - For dealing with multicollinearity or small number of predictors
   - Penalty regression (Ridge and LASSO)
   - Elastic net (sum of Ridge and LASSO)

9. Bayesian inference [Lecture note|Practical](https://www.notion.so/9-Bayesian-inference-6c12ca2ea14d4c55beb364f266f69800)
   - Baye's theorem
...
3. Tutoial 3[Tutoorial note](https://flatter11.github.io/6040/Tutorial-3)
   - Basic check of grouped/clustered data (lecture 5)
   - GEE (lecture 6)
   - LMM (lecture 5)
   - Penalty regression (lecture 8)
...
1. Penalty regression (Ridge and LASSO)
2. Elastic net (sum of Ridge and LASSO)

## 9

Compare Bayesian's inference with Frequenist inference.       
Bayesian inference approach is motivated by the lack of ways to incupy prior information. Parameter is variable => can say "probability that theta is between interval is 95%" which is eaiser to understand. Whereas in traditional appraoch, parameter is a constant where we dunno the value. 
